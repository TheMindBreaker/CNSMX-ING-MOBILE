...
class OrderService {
  ...
  Future<RequisitionsInfoModel> getRequisitionsByCreator() async {
    ...
    final response = await http.get(Uri.https('connect.construtec.mx', 'Purchases/Requisitions/getByCreatorMobile'), headers: headers);
  ...
  Future<RequisitionsProductModel> getRequisitionProducts(int reqId) async {
    ...
    final response = await http.get(Uri.https('connect.construtec.mx', 'Purchases/Requisitions/getProducts/' + reqId.toString()), headers: headers);
